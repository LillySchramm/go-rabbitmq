...
[![](https://godoc.org/github.com/lillyschramm/go-rabbitmq?status.svg)](https://godoc.org/github.com/lillyschramm/go-rabbitmq)![Deploy](https://github.com/lillyschramm/go-rabbitmq/workflows/Tests/badge.svg)
...
```bash
go get github.com/lillyschramm/go-rabbitmq
```
